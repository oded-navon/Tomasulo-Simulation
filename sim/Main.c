...
int main(int argc, char* argv[])
{
	...
	while (current_inst_in_instructions <= total_num_of_inst) {
...
void issue()
{
	...
	RS* rs = get_free_reservation_station();
